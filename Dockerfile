...
RUN pip install --no-cache-dir --extra-index-url https://download.pytorch.org/whl/cpu carvekit==4.1.2 fastapi==0.115.0 uvicorn==0.30.6 python-multipart==0.0.9 Pillow==10.4.0
